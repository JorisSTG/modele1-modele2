...
if uploaded_model1 and uploaded_model2:
    ...
    for mois_num in range(1, 13):
        ...
        ax.bar(df_plot["Temp_Num"] - 0.25, df_plot["source 2"], width=0.4, label="source 2", color=couleur_TRACC)
        ax.bar(df_plot["Temp_Num"] + 0.25, df_plot["source 1"], width=0.4, label="source 1", color=couleur_modele)
